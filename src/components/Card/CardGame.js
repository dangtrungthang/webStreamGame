        ...
        <div className="_column" style={{ width: "200px",borderColor:COLOR_BORDER_GAME,borderWidth:"1px",borderStyle:'solid' }}>
            ...
            <div style={{
               ...
               padding:'5px'
                ...
                <div className="_row" style={{ justifyContent: 'space-between',
                 alignItems: 'center' }}>
                    <a style={{ color: COLOR_COLOR_TEXT1 }}>{props.NameGame}</a>
                    <AiOutlineMore />
                </div>
                <div>
                    <a style={{ color: COLOR_NAME_GAME, fontSize: 14, color: "gray" }}>{props.Viewer}</a>
                </div>
                <div className="_row">
                    <div className="_borderTag" style={{borderColor:COLOR_BORDER_GAME,
                    ...
                    style={{borderColor:COLOR_BORDER_GAME,
                        background:COLOR_BORDER_GAME,color:'white',
                        fontSize:"10px",justifyContent:'center',alignItems:'center',display:'flex'}}>
                        <a>Hành động</a>
                    </div>
